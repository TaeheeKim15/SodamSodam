...
<a class="btn btn-primary box20" href='deleteAll?uno=${list[0].uno}' role="button">장바구니 비우기 </a>
</div>
  ...
  <div class="container box20" style="min-height: calc(100vh - 200px)">
	<table class="container mb-5, text-center">
	 <thead class="box7">
		...
		<tbody>
			<tr>
			   <td class="p-2"><img src="${post.photo}" width="110" height="110"></td>
			   <td><p class="h5">${post.sname}</p></td>
				 ...
				 <td><button type="button" class="btn btn-primary" onclick="basketDelete(${post.bno})">삭제</button></td>
			</tr>			
		</c:forEach>
		</tbody>
	</table>
  ...
  <div class="d-flex justify-content-end">
<a class="btn btn-primary container box20 box12" role="button" onclick="pay()">구매 </a>
</div>
